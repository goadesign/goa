...
type (
	...
	Application struct {
		...
		decoders     map[contentType]Decoder   // Registered decoders for the service
		encoders     map[contentType]io.Writer // Registered encoders for the service
	}
...
func New(name string) Service {
	...
	decoders := make(map[contentType]Decoder, len(JSONContentTypes)+len(GobContentTypes))
	for contentTypeStr := range JSONContentTypes {
		// TODO: implement default decoders
		decoders[contentType(contentTypeStr)] = Decoder
	}

	for contentTypeStr := range GobContentTypes {
		// TODO: implement default decoders
		decoders[contentType(contentTypeStr)] = Decoder
	}

	// Loop through the default content types to initialize the encoder map
	encoders := map[contentType]io.Writer{}
