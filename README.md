<p align="center">
  ...
  <p align="center">
    ...
    <a href="https://pkg.go.dev/goa.design/goa/v3@v3.14.4/dsl?tab=doc"><img alt="Go Doc" src="https://img.shields.io/badge/godoc-reference-blue.svg?style=for-the-badge"></a>
...
<div style="display: flex; width: 100%; border: none; align-items: flex-start;">
    <div style="flex: 0 0 200px; display: flex; padding-right: 10px; border: none;">
    ...
    <div style="flex-grow: 1; display: block; border: none;">
...
The [DSL Go Doc](https://pkg.go.dev/goa.design/goa/v3@v3.14.4/dsl?tab=doc)
