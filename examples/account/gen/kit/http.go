...
func CreateAccountDecodeRequest(decoder func(*http.Request) rest.Decoder) httptransport.DecodeRequestFunc {
...
func CreateAccountEncodeResponse(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string)) httptransport.EncodeResponseFunc {
...
func CreateAccountEncodeError(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string), logger goa.LogAdapter) httptransport.ErrorEncoder {
...
func ListAccountDecodeRequest(decoder func(*http.Request) rest.Decoder) httptransport.DecodeRequestFunc {
...
// for encoding the create account responses.
func ListAccountEncodeResponse(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string)) httptransport.EncodeResponseFunc {
...
func ListAccountEncodeError(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string), logger goa.LogAdapter) httptransport.ErrorEncoder {
	enc := rest.EncodeError(encoder, logger)
	return func(ctx context.Context, err error, w http.ResponseWriter) {
		r := ctx.Value(reqKey)
		if r == nil {
			w.WriteHeader(http.StatusInternalServerError)
...
// for decoding create account requests.
func ShowAccountDecodeRequest(decoder func(*http.Request) rest.Decoder) httptransport.DecodeRequestFunc {
...
// for encoding the create account responses.
func ShowAccountEncodeResponse(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string)) httptransport.EncodeResponseFunc {
...
func ShowAccountEncodeError(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string), logger goa.LogAdapter) httptransport.ErrorEncoder {
	enc := rest.EncodeError(encoder, logger)
	return func(ctx context.Context, err error, w http.ResponseWriter) {
		r := ctx.Value(reqKey)
		if r == nil {
...
// for decoding create account requests.
func DeleteAccountDecodeRequest(decoder func(*http.Request) rest.Decoder) httptransport.DecodeRequestFunc {
...
// for encoding the create account responses.
func DeleteAccountEncodeResponse(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string)) httptransport.EncodeResponseFunc {
...
func DeleteAccountEncodeError(encoder func(http.ResponseWriter, *http.Request) (rest.Encoder, string), logger goa.LogAdapter) httptransport.ErrorEncoder {
	enc := rest.EncodeError(encoder, logger)
	return func(ctx context.Context, err error, w http.ResponseWriter) {
		r := ctx.Value(reqKey)
		if r == nil {
