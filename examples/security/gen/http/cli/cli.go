...
Example:
    `+os.Args[0]+` --transport=http secured-service secure --fail true --token "Tempore aut animi officiis."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` --transport=http secured-service also-doubly-secure --key "abcdef12345" --oauth-token "Praesentium minus possimus ab asperiores." --token "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ" --username "user" --password "password"
`, os.Args[0])
}
