...
var _ = Describe("Generate", func() {
	...
	Context("with an basic action", func() {
		...
		It("generates the ActionRouteResponse test methods ", func() {
			...
			Ω(content).Should(ContainSubstring("GetFooOK(t testing.TInterface, ctx context.Context, service *goa.Service, ctrl app.FooController, payload app.CustomName) (http.ResponseWriter, error)"))
		})
