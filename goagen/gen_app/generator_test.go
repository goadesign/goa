...
const contextsCodeTmpl = `// API "test api": Application Contexts
//
// Code generated by goagen {{ .version }}, DO NOT EDIT.
//
// Command:
// $ goagen
...
const controllersCodeTmpl = `// API "test api": Application Controllers
//
// Code generated by goagen {{ .version }}, DO NOT EDIT.
//
// Command:
...
const hrefsCodeTmpl = `// API "test api": Application Resource Href Factories
//
// Code generated by goagen {{.version}}, DO NOT EDIT.
//
// Command:
...
const mediaTypesCodeTmpl = `// API "test api": Application Media Types
//
// Code generated by goagen {{ .version }}, DO NOT EDIT.
//
// Command:
