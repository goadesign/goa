...
func (a *EndpointExpr) Name() string {
	return a.MethodExpr.Name
}

// Description of HTTP endpoint
func (a *EndpointExpr) Description() string {
	return a.MethodExpr.Description
}

// EvalName returns the generic expression name used in error messages.
func (a *EndpointExpr) EvalName() string {
...
func (a *EndpointExpr) PathParams() *design.MappedAttributeExpr {
...
// routes.
func (a *EndpointExpr) QueryParams() *design.MappedAttributeExpr {
	allParams := a.AllParams()
...
// all its routes.
func (a *EndpointExpr) AllParams() *design.MappedAttributeExpr {
...
func (a *EndpointExpr) Headers() *design.AttributeExpr {
	if a.headers == nil {
...
func (a *EndpointExpr) MappedHeaders() *design.MappedAttributeExpr {
...
func (a *EndpointExpr) Params() *design.AttributeExpr {
	if a.params == nil {
...
func (a *EndpointExpr) Validate() error {
...
func (a *EndpointExpr) validateParams() *eval.ValidationErrors {
	if a.params == nil {
		return nil
	}
	verr := new(eval.ValidationErrors)
...
func (a *EndpointExpr) validateHeaders() *eval.ValidationErrors {
	if a.headers == nil {
		return nil
	}
	verr := new(eval.ValidationErrors)
