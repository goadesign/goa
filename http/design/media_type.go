...
// name of the view.
func (p *Projector) Project(m *MediaTypeExpr, view string) (*MediaTypeExpr, design.Object, error) {
	var viewID string
...
func (m *MediaTypeExpr) projectSingle(view, viewID string) (p *MediaTypeExpr, links design.Object, err error) {
	v, ok := m.Views[view]
	if !ok {
