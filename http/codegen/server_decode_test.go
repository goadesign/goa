...
func TestDecode(t *testing.T) {
	cases := []struct {
		...
		{"decode-constructor-union", testdata.ConstructorUnionHTTPDSL},
		{"decode-constructor-union-custom-keys", testdata.ConstructorUnionCustomKeysHTTPDSL},
		{"decode-constructor-union-optional-body-with-header", testdata.ConstructorUnionOptionalBodyWithHeaderHTTPDSL},
		{"decode-constructor-union-required-body-with-header", testdata.ConstructorUnionRequiredBodyWithHeaderHTTPDSL},
		{"decode-nested-constructor-union", testdata.NestedConstructorUnionHTTPDSL},
		{"decode-nested-top-level-constructor-union-custom-keys", testdata.NestedTopLevelConstructorUnionCustomKeysHTTPDSL},
