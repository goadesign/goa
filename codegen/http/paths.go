...
func PathFiles(root *http.RootExpr) []codegen.File {
...
func serverPath(svc *http.ServiceExpr) codegen.File {
...
// for the given service.
func clientPath(svc *http.ServiceExpr) codegen.File {
...
func pathSections(svc *http.ServiceExpr, pkg string) codegen.SectionsFunc {
