...
func ServerFiles(root *http.RootExpr) []codegen.File {
...
func server(svc *http.ServiceExpr) codegen.File {
...
// decoding logic.
func serverEncodeDecode(svc *http.ServiceExpr) codegen.File {
