...
func ClientFiles(root *http.RootExpr) []codegen.File {
...
func client(r *http.ServiceExpr) codegen.File {
...
// decoding logic.
func clientEncodeDecode(svc *http.ServiceExpr) codegen.File {
...
func clientStructTmpl(r *http.ServiceExpr) *template.Template {
	return template.Must(transTmpl(r).New("client-struct").Parse(clientStructT))
}

func clientInitTmpl(r *http.ServiceExpr) *template.Template {
	return template.Must(transTmpl(r).New("client-constructor").Parse(clientInitT))
}

func endpointInitTmpl(r *http.ServiceExpr) *template.Template {
	return template.Must(transTmpl(r).New("client-endpoint").Parse(endpointInitT))
}

func requestEncoderTmpl(r *http.ServiceExpr) *template.Template {
	return template.Must(transTmpl(r).New("request-encoder").Parse(requestEncoderT))
}

func responseDecoderTmpl(r *http.ServiceExpr) *template.Template {
