...
func TestCompatible(t *testing.T) {
	cases := []struct {
		...
		{"invalid-obj-3", obj, objT3{}, "types don't match: could not find field \"Baz\" of external type service.objT3 matching attribute \"Baz\" of type \"objT\""},
