...
func TestService(t *testing.T) {
	cases := []struct {
		...
		{"service-level-error-with-api-level-error", testdata.ServiceErrorWithAPIErrorDSL, testdata.ServiceErrorWithAPIError},
		{"service-level-error-with-method-level-error", testdata.ServiceErrorWithMethodErrorDSL, testdata.ServiceErrorWithMethodError},
		{"service-level-error-with-custom-api-level-error", testdata.ServiceErrorWithCustomAPIErrorDSL, testdata.ServiceErrorWithCustomAPIError},
		{"service-level-error-with-custom-method-level-error", testdata.ServiceErrorWithCustomMethodErrorDSL, testdata.ServiceErrorWithCustomMethodError},
		{"service-level-error-with-api-level-error-duplicate", testdata.ServiceErrorWithAPIErrorDuplicateDSL, testdata.ServiceErrorWithAPIErrorDuplicate},
		{"service-level-error-with-method-level-error-duplicate", testdata.ServiceErrorWithMethodErrorDuplicateDSL, testdata.ServiceErrorWithMethodErrorDuplicate},
