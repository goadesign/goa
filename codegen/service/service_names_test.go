...
func TestServiceNameRolesOwnDeclarationKinds(t *testing.T) {
	tests := []struct {
		...
		{serviceInterceptorMethodInfoNameRole, codegen.NameType},
		{serviceInterceptorServerUnaryInfoNameRole, codegen.NameType},
		{serviceInterceptorClientUnaryInfoNameRole, codegen.NameType},
		{serviceInterceptorStreamingSendInfoNameRole, codegen.NameType},
		{serviceInterceptorStreamingRecvInfoNameRole, codegen.NameType},
