...
//
// The resource DSL allows listing the supported resource actions. Each action
// corresponds to a single API endpoint. See Action.
//
// The resource DSL also allows setting the resource default media type. This
// media type is used to render the response body of actions that return the OK
// response (unless the action overrides the default). The default media type
// also sets the properties of the request payload attributes with the same
// name. See DefaultMedia.
//
// The resource DSL can also specify a parent resource. Defining a parent
...
// action path). The resource definition may specify a canonical action via
// CanonicalActionName to override that default.
//
// Resource is a top level DSL.
//
// Resource accepts two arguments: the name of the resource and its defining
// API.
//
// Example:
//
...
//         UseTrait("Authenticated")       // Included trait
//
